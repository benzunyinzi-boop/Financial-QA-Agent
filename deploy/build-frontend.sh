...
echo "  scp $TAR_FILE root@YOUR_ECS_IP:/opt/Financial-QA-Agent/"
echo "  # 然后在 ECS 上："
echo "  cd /opt/Financial-QA-Agent"
echo "  tar -xzf $TAR_FILE"
echo ""
echo "方式 2：rsync 增量同步 dist（推荐更新时用）"
echo "  rsync -avz --delete frontend/dist/ root@YOUR_ECS_IP:/opt/Financial-QA-Agent/frontend/dist/"
echo ""
echo "上传后，在 ECS 上执行："
